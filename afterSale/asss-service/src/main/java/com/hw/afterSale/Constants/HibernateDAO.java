...
import com.thinvent.data.hibernate.SimpleHibernateDAO;
...
public class HibernateDAO<T, Id extends Serializable> extends SimpleHibernateDAO<T, Id> implements BaseDAO<T, Id> {
     ...
     */
    @Override
    public String findUniqueStringBySql(CharSequence sql, Map<String, Object> namedParameters) {
        return (String) createSqlQuery(sql.toString(), namedParameters).uniqueResult();
    }
     ...
     */
    @Override
    public Integer findUniqueIntegerBySql(CharSequence sql, Map<String, Object> namedParameters) {
        return (Integer) createSqlQuery(sql.toString(), namedParameters).uniqueResult();
    }
